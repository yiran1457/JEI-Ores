...
import net.yiran.jei_ores.networking.packet.Packet;
import net.yiran.jei_ores.networking.packet.S2CSendBiomeInfoPacket;
import net.yiran.jei_ores.networking.packet.S2CSendFeaturesPacket;
...
public class JeiOresPacketHandler {
